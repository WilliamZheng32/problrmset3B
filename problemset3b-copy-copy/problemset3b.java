...
public class problemset3b {
    public static void main(String[]args){
        ...
        String playerchoice = response.substring(find+1,response.length());
        System.out.println(playerchoice);

        if(stringlength < 50){
            if(playerchoice.equals("rock")){
                System.out.print("Pathetic. You cannot hope to beat me without the passion of a thousand suns, without the dedication of a Pleistocene glacier! I choose PAPER!");
